    ...
    <div class="item-head">
      <div class="container">
        <div class="row">
          <div class="item-img">
            <img
              src="assets/img/할인이미지/당신의 이름은.png" height="600"
              alt=""
            />
          </div>
          <div class="info-head">
            ...
            <div class="info">
              <div>
                ...
                <p>2020-12-12~2020-12-13</p>
              </div>
              <div>
                <h3 class="time">공연시간</h3>
                <p>토, 일 08:00pm~09:30pm</p>
              </div>
              <div>
                <h3 class="age">연령</h3>
                <p>12세 이상</p>
              ...
              <div>
                ...
                <p>2020 프로젝트 클라우드나인 기획공연<br>
                 공연관람 1일 전까지 전화 예매 후 티켓수령시 할인티켓지참(미지참시 차액지불)/ 중복할인 불가</p>
              </div>
              <div>
                <h3 class="sales">금액</h3>
                <p style="text-decoration: line-through;">20,000원</p><br>
                <p style="    font-weight: bold;
    color: #dc143c;">14,000원(30%할인)</p>
              </div>
              <p class="Detail">
          ...
          <div class="reservation-btn">
            <a href="reservation13.jsp">예매하기</a>
          </div>
        </div>
      </div>
    </div>
