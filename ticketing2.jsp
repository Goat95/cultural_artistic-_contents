    ...
    <div class="item-head">
      <div class="container">
        <div class="row">
          <div class="item-img">
            <img
              src="assets/img/무용,뮤지컬,클래식/청춘만발.jpg" height="600"
              alt=""
            />
          </div>
          <div class="info-head">
            ...
            <div class="info">
              <div>
                ...
                <p>2020-12-01~2020-12-13</p>
              </div>
              <div>
                <h3 class="time">공연시간</h3>
                <p>화~금 20시(토,일,월요일 공연없음)</p>
              </div>
              <div>
                <h3 class="age">연령</h3>
                <p>8세 이상(취학아동 이상)</p>
              ...
              <div>
                ...
                <p>청년국악인들의 첫 무대<br>
                ※ 티켓판매 오픈일시 : 2020년 11월 30일(월) 10:00am <br>
                ※ 정동마루 : 정동극장(서울) 내 카페정담 2층에 위치 ※ 비지정석 : 공연당일 입장순으로 자리 선점</p>
              </div>
              <div>
          ...
          <div class="reservation-btn">
            <a href="reservation3.jsp">예매하기</a>
          </div>
        </div>
      </div>
    </div>
