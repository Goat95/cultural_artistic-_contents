          ...
          <div class="person-info">
            ...
            <form name="form" action="pay1.jsp" method="post">
              <div>
                ...
                <INPUT type="text" readonly value="2020 정동극장 (김주원의 사군자 생의 계절)" name="title">
              </div>
              <div>
              ...
              <div>
                ...
                <select name="date" id="date">
                  ...
                  <option value="2020-11-21 토 오후 2시">2020-11-21 토 오후 2시</option>
                  <option value="2020-11-21 토 오후 6시">2020-11-21 토 오후 6시</option>
                  <option value="2020-11-22 일 오후 3시">2020-11-22 일 오후 3시</option>
                  <option value="2020-11-24 화 오후 8시">2020-11-24 화 오후 8시</option>
                  <option value="2020-11-25 수 오후 8시">2020-11-25 수 오후 8시</option>
                  <option value="2020-11-26 목 오후 8시">2020-11-26 목 오후 8시</option>
                  <option value="2020-11-27 금 오후 8시">2020-11-27 금 오후 8시</option>
                  <option value="2020-11-28 토 오후 2시">2020-11-28 토 오후 2시</option>
                  <option value="2020-11-28 토 오후 6시">2020-11-28 토 오후 6시</option>
                  <option value="2020-11-29 일 오후 3시">2020-11-29 일 오후 3시</option>
                </select>
              </div>
              <div class="ticket-amount">
                ...
                <input type="hidden" name="sell_price" value="70000" />
              </div>
                <div>
                <label for="">금액 : </label>
