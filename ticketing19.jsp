    ...
    <div class="item-head">
      <div class="container">
        <div class="row">
          <div class="item-img">
            <img
              src="assets/img/할인이미지/호비쇼.jpg" height="600"
              alt=""
            />
          </div>
          <div class="info-head">
            ...
            <div class="info">
              ...
              <div>
                ...
                <p>중복할인 불가/ ※매진시 사용불가능 2020 어린이율동놀이뮤지컬</p>
              </div>
              <div>
                <h3 class="sales">금액</h3>
                <p style="text-decoration: line-through;">35,000원</p><br>
                <p style="    font-weight: bold;
    color: #dc143c;">21,000원(40%할인)</p>
              </div>
              <p class="Detail">
          ...
          <div class="reservation-btn">
            <a href="reservation17.jsp">예매하기</a>
          </div>
        </div>
      </div>
    </div>
