    ...
    <div class="item-head">
      <div class="container">
        <div class="row">
          <div class="item-img">
            <img
              src="assets/img/무용,뮤지컬,클래식/생의 계절.jpg" height="600"
              alt=""
            />
          </div>
          <div class="info-head">
            <h2>2020 정동극장 (김주원의 사군자 생의 계절)</h2>
            <div class="info">
              <div>
                <h3 class="date">공연기간</h3>
                <p>2020-11-16~2020-11-29</p>
              </div>
              <div>
                <h3 class="time">공연시간</h3>
                <p>화-금 20시 (월요일 공연없음)</p>
                <p>토 14시, 18시 / 일 15시</p>
              </div>
              <div>
                <h3 class="age">연령</h3>
              ...
              <div>
                ...
                <p>정동극장 25주년 기념공연<br>
                ※ 티켓판매 오픈 일시 : 2020년 9월 27일(목) <br>
                ※ 코로나19 확산 방지 및 예방을 위해 ‘한 칸 띄어 앉기’ 좌석제로 운영됩니다. <br>
          ...
          <div class="reservation-btn">
            <a href="reservation1.jsp">예매하기</a>
          </div>
        </div>
      </div>
    </div>
