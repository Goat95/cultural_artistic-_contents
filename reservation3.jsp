          ...
          <div class="person-info">
            ...
            <form name="form" action="pay1.jsp" method="post">
              <div>
                ...
                <INPUT type="text" readonly value="청춘만발" name="title">
              </div>
              <div>
                <label for="name">장소 : </label>
                <INPUT type="text" readonly value="정동극장 정동마루" name="venue">
              </div>
              <div>
              ...
              <div>
                ...
                <select name="date" id="date">
                  <option value="2020-12-1 수 오후 8시">2020-12-1 수 오후 8시</option>
                  <option value="2020-12-2 목 오후 8시">2020-12-2 목 오후 8시</option>
                  <option value="2020-12-3 금 오후 8시">2020-12-3 금 오후 8시</option>
                  <option value="2020-12-4 토 오후 8시">2020-12-4 토 오후 8시</option>
                  <option value="2020-12-8 토 오후 8시">2020-12-8 토 오후 8시</option>
                  <option value="2020-12-9 일 오후 8시">2020-12-9 일 오후 8시</option>
                  <option value="2020-12-10 수 오후 8시">2020-12-10 수 오후 8시</option>
                  <option value="2020-12-11 목 오후 8시">2020-12-11 목 오후 8시</option>
                </select>
              </div>
