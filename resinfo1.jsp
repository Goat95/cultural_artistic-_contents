      ...
      <div class="row">
        <section class="reservation-wrap">
          <div class="reservation-info">
            <h2 style="text-align: center;">예매 정보</h2>
            	<%
    				...
    				System.out.println(sk + "<-- sk resinfo1.jsp");
    				System.out.println(sv + "<-- sv resinfo1.jsp");
    				...
    				try{
        				...
        				if(sk == null & sv == null){
            				pstmt = conn.prepareStatement("select * from pay");
			        	}else if(sk != null & sv.equals("")){
            			pstmt = conn.prepareStatement("select * from pay");
				        }else if(sk != null & sv != null){
            			pstmt = conn.prepareStatement("select * from pay where "+sk+"=?");
            			pstmt.setString(1, sv);
				        }
        				rs = pstmt.executeQuery();
        				System.out.println(rs + "<-- resinfo1.jsp");
        				while(rs.next()){
   				%>
            <div>
            ...
            <div>
              <label for="name">예매자 성함 &nbsp;&nbsp;&nbsp;: </label>
              <p><%= rs.getString("name")%></p>
            </div>
            <div>
              <label for="contact">예매자 연락처 : </label>
              <p><%= rs.getString("tel")%></p>
            </div>
            <div>
              <label for="contact">예매자 메일 &nbsp;&nbsp;&nbsp;: </label>
              <p><%= rs.getString("mail")%></p>
            </div>
            <div>
              <label for="mail">예매 일시 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </label>
              <p><%= rs.getString("date")%></p>
            </div>
            <div>
              <label for="date">티켓 매수 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </label>
              <p><%= rs.getString("amount")%></p>
            </div>
            <div class="ticket-amount">
              <label for="">결제금액 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </label>
              <p><%= rs.getString("sum")%>원</p>
            </div>
                    <% 
        			}    
