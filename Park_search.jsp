				...
				<ul>
					<li>
						<div class="Logo" style="width: 170px; height: 70px;">
							<h1><img src="logo.png" alt="http://localhost:8090/WebTest/Park_search.jsp" style="width: 100%; height: 100%; padding-top: 5px; cursor: pointer;"></h1>
						</div>
					</li>
					<li>
	...
	<div class="header-Menu-background">
			<div class="header-MenuBox">
				<ul>
					...
					<li><a href="http://localhost:8090/WebTest/Park_search.jsp" style="color:black;">공원검색</a></li>
	...
	<div class="articleCard" style="padding-top:50px; ">
		<ul class="clearfix">
			<li style="width:40%;height:600px; box-sizing: border-box; border-right:1px solid #000;position: relative; background-color: #fff;">
				<div class="notice">
					<form action="Park_search.jsp" method="post">
    				...
    				System.out.println(sk + "<-- sk Park_search.jsp");
    				System.out.println(sv + "<-- sv Park_search.jsp");
    				...
    				try{
        				...
        				System.out.println(rs + "<-- Park_search.jsp");
        				while(rs.next()){
   					%>
   					<div class="list">
   					<ul>
   					<li id="1">
						<dl>
							<dt style="color: #0000FF;"><%= rs.getString("Park_Name")%></dt>
							<dd>
								<ul style="padding: 10px 0 10px 10px; border-top: 1px solid #dadada;">
									<li style="position: relative; margin-top: 10px; margin-top: 10px;">
										<span class="title" style="position: absolute; padding-left: 5px;">공원구분</span>
										<span class="detail" style="display: block; padding-left: 145px; color: #828282;"><%= rs.getString("Park_Division")%></span>
									</li>
									<li style="position: relative; margin-top: 10px; margin-top: 10px;">
										<span class="title" style="position: absolute; padding-left: 5px;">공원주소</span>
										<span class="detail" style="display: block; padding-left: 145px; color: #828282;"><%= rs.getString("Address")%></span>
									</li>
									<li style="position: relative; margin-top: 10px; margin-top: 10px;">
										<span class="title" style="position: absolute; padding-left: 5px;">공원면적</span>
										<span class="detail tel" style="display: block; padding-left: 145px; color: #828282;"><%= rs.getString("Park_Area")%>㎡</span>
									</li>
									<li style="position: relative; margin-top: 10px; margin-top: 10px;">
										<span class="title" style="position: absolute; padding-left: 5px;">공원보유운동시설</span>
										<span class="detail" style="display: block; padding-left: 145px;"><%= rs.getString("Exercise_Facility")%></span>
									</li>
									<li style="position: relative; margin-top: 10px; margin-top: 10px;">
										<span class="title" style="position: absolute; padding-left: 5px;">공원보유유희시설</span>
										<span class="detail" style="display: block; padding-left: 145px;"><%= rs.getString("Amusement_Facility")%></span>
									</li>
									<li style="position: relative; margin-top: 10px; margin-top: 10px;">
										<span class="title" style="position: absolute; padding-left: 5px;">공원보유편익시설</span>
										<span class="detail" style="display: block; padding-left: 145px;"><%= rs.getString("Convenience_Facility")%></span>
									</li>
									<li style="position: relative; margin-top: 10px; margin-top: 10px;">
										<span class="title" style="position: absolute; padding-left: 5px;">공원보유교양시설</span>
										<span class="detail" style="display: block; padding-left: 145px;"><%= rs.getString("Culture_Facility")%></span>
									</li>
									<li style="position: relative; margin-top: 10px; margin-top: 10px;">
										<span class="title" style="position: absolute; padding-left: 5px;">공원보유기타시설</span>
										<span class="detail" style="display: block; padding-left: 145px;"><%= rs.getString("Other_Facility")%></span>
									</li>
									<li style="position: relative; margin-top: 10px; margin-top: 10px;">
										<span class="title" style="position: absolute; padding-left: 5px;">공원전화번호</span>
										<span class="detail" style="display: block; padding-left: 145px; color: #FF0040;"><%= rs.getString("Phone_Number")%></span>
									</li>
									<li style="position: relative; margin-top: 10px; margin-top: 10px;">
										<span class="title" style="position: absolute; padding-left: 5px;">관할 자치구</span>
										<span class="detail" style="display: block; padding-left: 145px; color: #828282;"><%= rs.getString("Management_Agency")%></span>
										<br><br>
									</li>
								</ul>
							</dd>
...
var marker = new naver.maps.Marker({
	position: new naver.maps.LatLng(<%= rs.getBigDecimal("Latitude")%>, <%= rs.getBigDecimal("Hardness")%>),
	map: map
});
var marker = new naver.maps.Marker({
	position: new naver.maps.LatLng(37.5568090000, 126.8138050000),
	map: map
});
var marker = new naver.maps.Marker({
	position: new naver.maps.LatLng(37.5521941000, 127.0693887000),
	map: map
});
