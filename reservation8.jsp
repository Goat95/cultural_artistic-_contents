          ...
          <div class="person-info">
            ...
            <form name="form" action="pay1.jsp" method="post">
              <div>
                ...
                <INPUT type="text" readonly value="적벽" name="title">
              </div>
              <div>
              ...
              <div>
                ...
                <select name="date" id="date">
                  <option value="2020-11-21 토 오후 3시">2020-11-21 토 오후 3시</option>
                  <option value="2020-11-22 일 오후 3시">2020-11-22 일 오후 3시</option>
                  <option value="2020-11-23 월 오후 8시">2020-11-23 월 오후 8시</option>
                  ...
                  <option value="2020-11-28 토 오후 3시">2020-11-28 토 오후 3시</option>
                  <option value="2020-11-29 일 오후 3시">2020-11-29 일 오후 3시</option>
                  <option value="2020-11-30 월 오후 8시">2020-11-30 월 오후 8시</option>
                </select>
              </div>
              <div class="ticket-amount">
                ...
                <input type="hidden" name="sell_price" value="60000" />
              </div>
                <div>
                <label for="">금액 : </label>
