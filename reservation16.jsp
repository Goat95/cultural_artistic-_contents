          ...
          <div class="person-info">
            ...
            <form name="form" action="pay1.jsp" method="post">
              <div>
                ...
                <INPUT type="text" readonly value="오아시스 세탁소 습격사건" name="title">
              </div>
              <div>
                <label for="name">장소 : </label>
                <INPUT type="text" readonly value="일과핵소극장" name="venue">
              </div>
              <div>
              ...
              <div>
                ...
                <select name="date" id="date">
                  ...
                  <option value="2020-11-9 월 오후 3시">2020-11-9 월 오후 3시</option>
                  <option value="2020-11-10 화 오후 3시">2020-11-10 화 오후 3시</option>
                  <option value="2020-11-11 수 오후 3시">2020-11-11 수 오후 3시</option>
                  <option value="2020-11-12 목 오후 3시">2020-11-12 목 오후 3시</option>
                </select>
              </div>
