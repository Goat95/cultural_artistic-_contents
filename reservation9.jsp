          ...
          <div class="person-info">
            ...
            <form name="form" action="pay1.jsp" method="post">
              <div>
                ...
                <INPUT type="text" readonly value="기술로 수작 부리기 : 메이커 문화 운동의 현재와 미래" name="title">
              </div>
              <div>
                <label for="name">장소 : </label>
                <INPUT type="text" readonly value="돌곶이 생화예술 문화센터" name="venue">
              </div>
              <div>
              ...
              <div>
                ...
                <select name="date" id="date">
                  <option value="2020-12-2 수 오후 3시">2020-12-2 수 오후 3시</option>
                  <option value="2020-12-9 수 오후 3시">2020-12-9 수 오후 3시</option>
                </select>
              </div>
              <div class="ticket-amount">
                ...
                <input type="hidden" name="sell_price" value="3000" />
              </div>
                <div>
                <label for="">금액 : </label>
