    ...
    <div class="item-head">
      <div class="container">
        <div class="row">
          <div class="item-img">
            <img
              src="assets/img/행사, 관람, 토크/무계원.png" height="600"
              alt=""
            />
          </div>
          <div class="info-head">
            <h2>종로문화재단 무계원 (종로문화재단×조선뉴스프레스 토크 콘서트: 조선토크)</h2>
            <div class="info">
              <div>
              ...
              <div>
                ...
                <p>무계원(서울시 종로구 창의문로 5가길 2)</p>
              </div>
              <div>
                <h3 class="description">설명</h3>
                <p>무계원 토크 콘서트: 조선토크<br>
                 1. 일 시 : 2020년 11월 24일 (화) 19:00~20:30 <br>
                 2. 장 소 : 무계원(서울시 종로구 창의문로 5가길 2) <br>
                 3. 출연진 : 박재연(대화교육 안내자), 최고은(싱어송라이터) <br>
                 4. 대 상 : 누구나(100명 선착순 접수) <br>
                 5. 관람료 : 무료 <br>
                 6. 프로그램 - 오프닝 공연(19:00) - 조선토크 소개(19:18) - 가족 간의 사랑대화 꿀팁(19:20) - 청중과의 대화(20:00) - 마무리 공연(20:15) - 행사 종료(20:30)<br>
                 7. 접수처 - 전화 접수 : 무계원(02-379-7131~2) <br>
                 ※ 우천 시에도 정상 진행합니다.<br>
                  ※ 주차 단속지역이므로 대중교통 이용 바랍니다.<br>
                   ※ 해당 공연은 비지정좌석제로 진행되며, 당일 현장 관람객이 많은 관계로 명단 확인 후 사전 접수자 우선 착석할 예정입니다. 지연 관객의 경우, 원내 입장은 가능하오나 좌석이 부족할 수 있으니 양해 부탁드립니다.</p>
              </div>
              <div>
