          ...
          <div class="person-info">
            ...
            <form name="form" action="pay1.jsp" method="post">
              <div>
                ...
                <INPUT type="text" readonly value="라면에 파송송" name="title">
              </div>
              <div>
                <label for="name">장소 : </label>
                <INPUT type="text" readonly value="석계 로즈아트홀" name="venue">
              </div>
              <div>
              ...
              <div>
                ...
                <select name="date" id="date">
                  <option value="2020-12-1 화 오후 5시">2020-12-1 화 오후 5시</option>
                  <option value="2020-12-2 수 오후 5시">2020-12-2 수 오후 5시</option>
                  <option value="2020-12-3 목 오후 5시">2020-12-3 목 오후 5시</option>
                </select>
              </div>
