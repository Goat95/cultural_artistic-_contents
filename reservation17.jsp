          ...
          <div class="person-info">
            ...
            <form name="form" action="pay1.jsp" method="post">
              <div>
                ...
                <INPUT type="text" readonly value="호비쇼 - 인천" name="title">
              </div>
              <div>
                <label for="name">장소 : </label>
                <INPUT type="text" readonly value="남동소래아트홀" name="venue">
              </div>
              <div>
              ...
              <div>
                ...
                <select name="date" id="date">
                  <option value="2020-11-16 월 오후 1시">2020-11-16 월 오후 1시</option>
                </select>
              </div>
