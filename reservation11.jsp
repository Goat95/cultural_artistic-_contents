          ...
          <div class="person-info">
            ...
            <form name="form" action="pay1.jsp" method="post">
              <div>
                ...
                <INPUT type="text" readonly value="月明(월명)" name="title">
              </div>
              <div>
                <label for="name">장소 : </label>
                <INPUT type="text" readonly value="정동극장 경주" name="venue">
              </div>
              <div>
              ...
              <div>
                ...
                <select name="date" id="date">
                  <option value="2020-11-13 금 오후 7시">2020-11-13 금 오후 7시</option>
                  <option value="2020-11-14 토 오후 7시">2020-11-14 토 오후 7시</option>
                  <option value="2020-11-20 금 오후 7시">2020-11-20 금 오후 7시</option>
                  <option value="2020-11-21 토 오후 7시">2020-11-21 토 오후 7시</option>
                  <option value="2020-11-27 금 오후 7시">2020-11-27 금 오후 7시</option>
                  <option value="2020-11-28 토 오후 7시">2020-11-28 토 오후 7시</option>
                </select>
              </div>
