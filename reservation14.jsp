          ...
          <div class="person-info">
            ...
            <form name="form" action="pay1.jsp" method="post">
              <div>
                ...
                <INPUT type="text" readonly value="지금도 가슴 설렌다" name="title">
              </div>
              <div>
                <label for="name">장소 : </label>
                <INPUT type="text" readonly value="대학로 선돌극장" name="venue">
              </div>
              <div>
              ...
              <div>
                ...
                <select name="date" id="date">
                  <option value="2020-12-26 토 오후 7시">2020-12-26 토 오후 7시</option>
                  <option value="2020-12-27 일 오후 7시">2020-12-27 일 오후 7시</option>
                  <option value="2020-12-28 월 오후 7시">2020-12-28 월 오후 7시</option>
                </select>
              </div>
