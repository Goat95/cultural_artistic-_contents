...
<header>
	...
	<div class="header-Menu-background">
			<div class="header-MenuBox">
				<ul>
					<li><a href="Park_search2.jsp" style="color:black;">공원검색</a></li>
		...
		<div class="contents borderBos" style="width:100%;, height: 100%; background-color: #fff;">
			...
			<div id="app" class="container" style="margin-top: 20px;">
				<div class="jumbotron" style="padding-top: 15px; padding-bottom: 15px;">
					<h5 style="background-color: #ffff; font-weight:bold;">#작성한 글의 수정과 삭제는 게시판 글의 작성자만이 가능합니다.</h5>
				</div>
				<form method="post" action="WrAction.jsp">
					...
					<thead>
						<tr>
							<th colspan="2" style="background-color: #eeeeee; width:40px; text-align: center; font-weight:bold;">게시판 글쓰기 양식</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td style="text-align: center; border: 1px solid #4444;"><input type="text" class="form-control" placeholder="글 제목"name="bbsTtitle" maxlength="50" style="height:40px; width:100%;"></td>
						</tr>
						<tr>
							<td style="text-align: center; border: 1px solid #4444;"><textarea type="text" class="form-control" placeholder="글 내용"name="bbsContent" maxlength="2048" style="height: 350px;width:100%;"></textarea></td>
						</tr>
					</tbody> 
			</table>
