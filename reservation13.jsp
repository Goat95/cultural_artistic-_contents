          ...
          <div class="person-info">
            ...
            <form name="form" action="pay1.jsp" method="post">
              <div>
                ...
                <INPUT type="text" readonly value="당신의 이름은 무엇입니까?" name="title">
              </div>
              <div>
                <label for="name">장소 : </label>
                <INPUT type="text" readonly value="마포아트센터 아트홀맥" name="venue">
              </div>
              <div>
              ...
              <div>
                ...
                <select name="date" id="date">
                  <option value="2020-12-12 토 오후 8시">2020-12-12 토 오후 8시</option>
                  <option value="2020-12-13 일 오후 8시">2020-12-13 일 오후 8시</option>
                </select>
              </div>
              <div class="ticket-amount">
                ...
                <input type="hidden" name="sell_price" value="14000" />
              </div>
                <div>
                <label for="">금액 : </label>
