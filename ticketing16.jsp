  ...
  <body>
    ...
    <div class="item-head">
      <div class="container">
        <div class="row">
          <div class="item-img">
            <img
              src="assets/img/할인이미지/지금도 가슴.gif" height="600"
              alt=""
            />
          </div>
          <div class="info-head">
            ...
            <div class="info">
              <div>
                ...
                <p>2020-12-26~2020-12-28</p>
              </div>
              <div>
                <h3 class="time">공연시간</h3>
                <p>토, 일, 월 07:00pm~08:00pm</p>
              </div>
              <div>
                <h3 class="age">연령</h3>
                <p>12세 이상</p>
    ...
    color: #dc143c;">18,000원(40%할인)</p>
          ...
          <div class="reservation-btn">
            <a href="reservation14.jsp">예매하기</a>
          </div>
        </div>
      </div>
    </div>
