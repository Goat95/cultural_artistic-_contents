    ...
    <div class="item-head">
      <div class="container">
        <div class="row">
          <div class="item-img">
            <img
              src="assets/img/행사, 관람, 토크/기술로 수작 부리기.jpg" height="600"
              alt=""
            />
          </div>
          <div class="info-head">
            <h2>기술로 수작 부리기 : 메이커 문화 운동의 현재와 미래</h2>
            <div class="info">
              <div>
                <h3 class="date">공연기간</h3>
                <p>2020-11-28~2020-12-10</p>
              </div>
              <div>
                <h3 class="time">공연시간</h3>
                <p>수 03:00pm ~ 05:00pm</p>
              </div>
              <div>
                <h3 class="age">연령</h3>
                <p>8세 이상</p>
              ...
              <div>
                ...
                <p>최근 전 세계적으로 메이커, 메이커 문화, 메이커 운동이 주목을 받고 있습니다. <br>
                무엇보다 한국을 포함한 각국 정부와 기업이 '메이커'를 이용한 정책개발을 진행하고 있습니다. <br>
                서울과학기술대학교 디지털문화정책학과는 한국연구재단의 지원으로 메이커문화의 지형 분석을 통한 정책적 방향성에 대한 연구를 진행하고 있습니다.<br>
                 관심있는 분들과 주제를 공유하고자 제작문화 콜로키움을 진행하려 합니다. <br>
                 장소 : 돌곶이 생화예술 문화센터<br>
                  강연자 : 이광석, 김성원, 오영진, 전승일, 장훈교, 송수연, 신현우, 임정희<br>
                   주최 : 서울과학기술대학교 IT정책대학원 디지털문화정책학과, 돌곶이 생화예술 문화센터</p>
              </div>
              <div>
          ...
          <div class="reservation-btn">
            <a href="reservation9.jsp">예매하기</a>
          </div>
        </div>
      </div>
    </div>
