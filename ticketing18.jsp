    ...
    <div class="item-head">
      <div class="container">
        <div class="row">
          <div class="item-img">
            <img
              src="assets/img/할인이미지/오아시스.jpg" height="600"
              alt=""
            />
          </div>
          <div class="info-head">
            ...
            <div class="info">
              <div>
                ...
                <p>2020-11-08~2020-11-12</p>
              </div>
              <div>
                <h3 class="time">공연시간</h3>
                <p>일, 월, 화, 수, 목 03:00pm~04:30pm</p>
              </div>
              <div>
                <h3 class="age">연령</h3>
                <p>전체 이용</p>
              ...
              <div>
                ...
                <p>1인 2매까지 30%할인 / 중복할인 불가</p>
              </div>
              <div>
                <h3 class="sales">금액</h3>
                <p style="text-decoration: line-through;">30,000원</p><br>
                <p style="    font-weight: bold;
    color: #dc143c;">21,000원(30%할인)</p>
              </div>
              <p class="Detail">
          ...
          <div class="reservation-btn">
            <a href="reservation16.jsp">예매하기</a>
          </div>
        </div>
      </div>
    </div>
