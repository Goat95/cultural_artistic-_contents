          ...
          <div class="person-info">
            ...
            <form name="form" action="pay1.jsp" method="post">
              <div>
                ...
                <INPUT type="text" readonly value="2020 동화책 속 세계여행" name="title">
              </div>
              <div>
              ...
              <div>
                ...
                <select name="date" id="date">
                  ...
                  <option value="2020-11-9 월 오전 10시">2020-11-9 월 오전 10시</option>
                  <option value="2020-11-10 화 오전 10시">2020-11-10 화 오전 10시</option>
                  <option value="2020-11-11 수 오전 10시">2020-11-11 수 오전 10시</option>
                  <option value="2020-11-12 목 오전 10시">2020-11-12 목 오전 10시</option>
                  <option value="2020-11-13 금 오전 10시">2020-11-13 금 오전 10시</option>
                  <option value="2020-11-16 월 오전 10시">2020-11-16 월 오전 10시</option>
                </select>
              </div>
