          ...
          <div class="person-info">
            ...
            <form name="form" action="pay1.jsp" method="post">
              <div>
                ...
                <INPUT type="text" readonly value="시나위, 몽" name="title">
              </div>
              <div>
              ...
              <div>
                ...
                <select name="date" id="date">
                  <option value="2020-10-28 수 오후 8시">2020-10-28 수 오후 8시</option>
                  <option value="2020-10-29 목 오후 8시">2020-10-29 목 오후 8시</option>
                  <option value="2020-10-30 금 오후 8시">2020-10-30 금 오후 8시</option>
                  <option value="2020-10-31 토 오후 2시">2020-10-31 토 오후 2시</option>
                  <option value="2020-10-31 토 오후 6시">2020-10-31 토 오후 6시</option>
                  <option value="2020-11-1 일 오후 3시">2020-11-1 일 오후 3시</option>
                  <option value="2020-11-4 수 오후 8시">2020-11-4 수 오후 8시</option>
                  <option value="2020-11-5 목 오후 8시">2020-11-5 목 오후 8시</option>
                  <option value="2020-11-6 금 오후 8시">2020-11-6 금 오후 8시</option>
                  <option value="2020-11-7 토 오후 2시">2020-11-7 토 오후 2시</option>
                  <option value="2020-11-7 토 오후 6시">2020-11-7 토 오후 6시</option>
              ...
              <div class="ticket-amount">
                ...
                <input type="hidden" name="sell_price" value="30000" />
              </div>
                <div>
                <label for="">금액 : </label>
