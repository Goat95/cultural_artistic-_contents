    ...
    <div class="item-head">
      <div class="container">
        <div class="row">
          <div class="item-img">
            <img
              src="assets/img/무용,뮤지컬,클래식/아랑가.jpg" height="600"
              alt=""
            />
          </div>
          <div class="info-head">
            ...
            <div class="info">
              <div>
                ...
                <p>2020-11-08~2020-11-22</p>
              </div>
              <div>
                <h3 class="time">공연시간</h3>
                <p>화,목,금 8시 / 수 4시, 8시</p>
                <p>토,일 3시, 6시30분</p>
              </div>
              <div>
                <h3 class="age">연령</h3>
                <p>8세 이상(2013.12.31 이전 출생자)</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p>2020 정동극장 공동기획 공연<br>
                화, 목, 금 오후 8시 / 수 오후 4시, 8시 / 토,일 오후 3시, 6시 30분 (월 공연 없음) <br>
                ※ 정동극장 홈페이지와 인터파크 예매 좌석은 연동됩니다.</p>
              </div>
              <div>
          ...
          <div class="reservation-btn">
            <a href="reservation4.jsp">예매하기</a>
          </div>
        </div>
      </div>
    </div>
