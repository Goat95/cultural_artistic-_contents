          ...
          <div class="person-info">
            ...
            <form name="form" action="pay1.jsp" method="post">
              <div>
                ...
                <INPUT type="text" readonly value="윤이상 탄생 100주년 기념 (Remembering Isang Yun)" name="title">
              </div>
              <div>
                <label for="name">장소 : </label>
                <INPUT type="text" readonly value="예술의 전당 IBK챔버홀" name="venue">
              </div>
              <div>
              ...
              <div>
                ...
                <select name="date" id="date">
                  <option value="2020-12-19 토 오후 2시">2020-12-19 토 오후 2시</option>
                </select>
              </div>
